...
export const mockActivities: Activity[] = [
  // 同理心驿站活动（周一到周六）
  {
    ...
    content: '在这次活动中，我们将通过角色扮演和实际场景模拟，学习如何在家庭环境中运用非暴力沟通原则。我们会探讨如何倾听孩子的真实需求，如何表达自己的感受而不带有评判，以及如何建立家庭成员之间的深度连接。',
    scheduledTime: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000), // 明天
  ...
  },
  {
    ...
    content: '职场环境中的沟通挑战往往复杂多样。在这次活动中，我们将模拟各种职场场景，学习如何在压力下保持同理心，如何处理同事间的冲突，以及如何在团队合作中建立信任和理解。',
    scheduledTime: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000), // 后天
  ...
  },
  {
    ...
    content: '亲密关系是我们练习非暴力沟通最重要的场所之一。我们将探讨如何在伴侣关系中表达真实的感受和需求，如何倾听对方的心声，以及如何共同创造一个安全、支持性的情感环境。',
  ...
  // 主题沙龙活动（每月一次）
  {
    ...
    content: '愤怒常被视为负面情绪，但在非暴力沟通中，愤怒是珍贵的信息载体。本次沙龙将深入探讨愤怒背后的需求信号，学习如何将愤怒的能量转化为设定健康边界的力量，以及如何在愤怒中保持心的连接。',
    scheduledTime: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000), // 5天后
  ...
  },
  {
    ...
    content: '新年是重新审视和改善人际关系的绝佳时机。我们将探讨如何释放过去关系中的怨恨和伤痛，如何用全新的视角看待身边的人，以及如何在新的一年中创造更多深度的、真实的人际连接。',
    scheduledTime: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000), // 30天后
  ...
  // 刘轶说生命成长活动（每季度一次）
  {
    ...
    content: '生命中的创伤和困难往往是我们最大的老师。刘轶老师将分享自己和众多学员的生命故事，探讨如何通过非暴力沟通的理念和实践，将生命中的痛苦转化为内在的智慧和力量，让创伤成为我们成长的礼物。',
    scheduledTime: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000), // 10天后
  ...
  },
  {
    ...
    content: '就像自然界有春夏秋冬，我们的生命也有不同的季节。刘轶老师将引导我们探索生命各个阶段的特点和意义，学会在人生的每一个季节中都能找到成长的机会和内在的力量源泉。',
    scheduledTime: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000), // 90天后
